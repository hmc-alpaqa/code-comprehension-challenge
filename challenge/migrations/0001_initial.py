# Generated by Django 3.2.5 on 2021-08-02 17:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='ChallengeTag',
            fields=[
                ('tag', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='Challenge Tag')),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            name='FactorTag',
            fields=[
                ('tag', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='Factor Tag')),
                ('challenge_tag', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='challenge.challengetag')),
            ],
        ),
        migrations.CreateModel(
