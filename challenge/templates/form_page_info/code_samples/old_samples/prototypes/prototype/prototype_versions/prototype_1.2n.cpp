...
void func1(int instruction_set[], int num_instructions, int input);
void func2(struct MysteryStruct* mystery_struct, int instruction_set[],
			       int num_instructions);

//Hidden
MysteryStruct* initialize_MysteryStruct();
void func3(MysteryStruct* mystery_struct);
void func4(MysteryStruct* mystery_struct);
...
MysteryStruct* func0(int input) {
  ...
  func2(mystery_struct, var2, var1);
...
void func2(MysteryStruct* mystery_struct, int input1[],
			      int input2) {
