...
void func_two(int input_one[], int len_one);
void func_three(int input_one[], int len_one, int var_one, int i);
...
void func_two(int input_one[], int len_one) { 
  ...
  for(int i = 0; i < len_one; i++) {
    ...
    func_three(input_one, len_one, var_one, i);
